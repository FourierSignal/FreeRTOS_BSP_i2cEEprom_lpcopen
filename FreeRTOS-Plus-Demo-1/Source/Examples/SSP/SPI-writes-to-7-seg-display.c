...
/*-----------------------------------------------------------*/
//
//lecture - this task is responsible for handling SPI port and seven-segment display !!!
//
//
static void prvSPIWriteTask( void *pvParameters )
{
...
const uint32_t xClockSpeed = 500000UL;
	...
	( void ) pvParameters;
    //
	//lecture - SPI- seven-segment - refer to LPCXpresso17xx-base-board.h
	//          and cmsis firmware driver library lpc17xx_gpio.c
	//
	...
	//
	//
	//lecture - similar to the above, but for another device on the SPI bus -
	//          disabling this device on the bus
	//
	...
	//
	//
	//lecture - refer to FreeRTOS_DriverInterface.c
	//
	//
