...
//
//
//lecture - this is the OLED initialization and IO transfers - this code is borrowed  from
//          EA samples and modified as per the requirements of FreeRTOS+IO stack
//
//
//
/* FreeRTOS includes. */
